...
O pacote `offlinecert` contem apenas a ferramenta local de assinatura de
certificados usada pelos scripts `sign-client` e `sign-vm-clients`. O broker em
execucao nao chama essas classes durante o tratamento normal das mensagens.
